...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5nZWxreSIsImEiOiJja242eHlmNDcwaXZ3MnRwNm9ldzhlNTFnIn0.W1GxyUQyIjTWPxCzpathfQ';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51IfHaXCeuA8hCixorpTTuoJaJXsbZxuF7uVqhfCOzVUjsxEeN8F9T6n5R9y3gxUtLPW2qptGCUvM5mONJoV6FFk600AJUqjD4n'); // 1) Get checkout session from API
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('photo', document.getElementById('photo').files[0]); // console.log('form', form);
